...
links.each_with_index do |link,i|
  ...
  if yes.include?("fomatguyane") and yes.include?("kourou")
      ...
      browser.execute_script("offer_search_search.value='#{job.gsub("'","\'")}';offer_search.parentElement.submit();") # Open the rest in new tabs
