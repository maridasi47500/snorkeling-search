...
# Array of links
links = ["https://www.flers-emplois.com/emploi/recherche.html?k=#{job}+#{ville}","https://jobs.eiffage.com/toutes-nos-offres?query=#{job}%20#{ville}&page=1","https://www.cyphoma.com/search?i18n_locale=fr&search%5Bcategories%5D=4f7b819dc7362771f90000cd&search%5Bcharacteristic_pe_contract%5D=&search%5Bcharacteristic_pe_experience%5D=&search%5Bcharacteristic_qualification%5D=&search%5Bcharacteristic_sector%5D=&search%5Blocations%5D=4f7cea54c736276288002ce4&search%5Bnew_product%5D=&search%5Border%5D=most_recent&search%5Bpage%5D=&search%5Bprice_site%5D%5Bfrom%5D=&search%5Bprice_site%5D%5Bto%5D=&search%5Bpro%5D=&search%5Bq%5D=#{job}&search%5Btype%5D=&search%5Burgent%5D=0&search%5Bwith_medium%5D=0","https://www.stages-emplois.com/recherche-emploi.php?qemploi=#{job}&qville=#{ville.downcase}","https://emploi.lefigaro.fr/offres-emploi/v/#{ville}-#{code}","https://www.jemepropose.com/annonces/#{ville}-#{codedpt}/?keywords=#{job}","https://www.adecco.fr/resultats-offres-emploi/s-informatique-technologie-de-l'information/","https://www.fomatguyane.fr/offres-d-emploi/offres-kourou","https://www.apec.fr/candidat/recherche-emploi.html/emploi?typesConvention=143684&typesConvention=143685&typesConvention=143686&typesConvention=143687&typesConvention=143706&motsCles=#{job}%20#{ville}&page=0","https://recrutement.education.gouv.fr/recrutement/offres?term=#{job}","https://choisirleservicepublic.gouv.fr/nos-offres/filtres/mot-cles/#{job}/","https://fr.linkedin.com/jobs/search?keywords=#{job}&location=#{ville}&geoId=&trk=public_jobs_jobs-search-bar_search-submit&position=1&pageNum=0","https://emplois.inclusion.beta.gouv.fr/search/employers/results?city=#{ville.downcase}-#{codedpt}","https://www.adecco.fr/resultats-offres-emploi/d-guyane-fran%C3%A7aise/","https://www.groupeactual.eu/offre-emploi?limit=&order=&keywords=#{job}&adresse=#{ville}%2C%20#{pays}&is_guiana=0&distance=10&niveau-experience=0%3B10&relations%5Bbesoin%5D%5Bcontrat%5D%5Bdebut%5D=&js_range_demarrage_dates=&informations%5Bremunerations%5D=0%3B100000&page=1","https://www.fomatguyane.fr/offres-d-emploi/offres-kourou","https://www.job-interim-guyane.fr/","https://antilles-guyane.fiderim.fr/search?offer_search%5Bsearch%5D=#{job}&offer_search%5Bcategory%5D=&offer_search%5Bplaces%5D%5B%5D=35&offer_search%5BagencyOffice%5D=&offer_search%5BactivityArea%5D=&offer_search%5Bjob%5D=&offer_search%5Bsubmit%5D=&offer_search%5B_token%5D=jt6yW_Av1NgWvPQzJ3xO0QnSYzZQS_hvEMGGYuT85ss","https://www.job-interim-guyane.fr/offres-emploi?title=#{job}&secteur_activite=All","https://www.blada.com/recherche/?spe=emploi&mc=#{job}%20#{ville}","https://www.jobijoba.com/fr/query/?what=#{job}&where=#{ville}&where_type=city","https://fr.jooble.org/SearchResult?rgns=#{ville}%2C%20#{pays}&ukw=#{job}","https://www.welcometothejungle.com/fr/jobs?refinementList%5Boffices.country_code%5D%5B%5D=GF&query=#{job}&page=1&aroundLatLng=#{lat}%2C#{lon}&aroundRadius=20&aroundQuery=#{ville}%2C%20#{pays}","https://www.optioncarriere.gf/emploi?s=#{job}&l=#{ville}%2C+#{pays}","https://www.hellowork.com/fr-fr/emploi/recherche.html?k=#{job}&k_autocomplete=&l=#{ville}+#{code}&l_autocomplete=http%3A%2F%2Fwww.rj.com%2Fcommun%2Flocalite%2Fcommune%2F#{code}&st=relevance&d=all","https://fr.indeed.com/jobs?q=#{job}&l=#{ville}+%28GF%29&from=searchOnHP%2Cwhatautocomplete&vjk=705d5a5133b8991c","https://candidat.francetravail.fr/offres/recherche?lieux=#{code}&motsCles=#{job}&offresPartenaires=true&range=0-19&rayon=10&tri=0"]
